...
describe("routes wildcard", () => {
  ...
  it("should call router.all", () => {
    expect(mockRouter.all).toHaveBeenCalledOnceWith("/(.*)", jasmine.any(Function));
  });

  describe("generic handler", () => {
    let req, resp, next, push, getMany$, getOne$, getManyErrors, getOneErrors, onError;
    ...
    describe("with ack", () => {
      ...
      it("should call errors", () => {
        expect(getOneErrors.errors).toHaveBeenCalledOnceWith(jasmine.any(Function));
      });
    ...
    describe("with no ack", () => {
      ...
      it("should call errors", () => {
        expect(getManyErrors.errors).toHaveBeenCalledOnceWith(jasmine.any(Function));
      });
