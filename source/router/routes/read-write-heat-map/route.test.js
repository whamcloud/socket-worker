...
describe('readWriteHeatMap', () => {
  ...
  beforeEach(() => {
    getDurationStream = jasmine
      .createSpy('getDurationStream')
      .and.returnValue(duration$);

    getRangeStream = jasmine
      .createSpy('getRangeStream')
      .and.returnValue(range$);
    ...
    jest.mock(
      './router/routes/read-write-heat-map/streams.js',
      () => mockStreams
    );
  ...
  it('should call router.get', () => {
    expect(mockRouter.get).toHaveBeenCalledOnceWith(
      '/read-write-heat-map',
